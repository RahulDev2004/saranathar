                      ...
                      <Row className="h-full w-[70%] mb-[12px] mx-auto">
                        <Col className="h-full justify-center flex-col relative flex items-center">
                          ...
                          <m.div
                            ...
                            <Buttons ariaLabel="packge book link" href="#" className="bg-darkgray text-[#fff] hover:bg-white hover:text-darkgray hover:border-transparent border-transparent mt-[10px] btn-fancy font-medium font-serif rounded-none uppercase btn-fancy md:mb-[15px]" color="#fff" size="md" title="Goto Gallery" />
                          </m.div>
                        </Col>
                      </Row>
                    </Container>
