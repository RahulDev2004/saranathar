                ...
                <Container>
                    <Row>
                        ...
                        <Col lg={3} sm={6} className="xs:mb-[25px]">
                            ...
                            <p className="w-[85%] mb-[15px]">No 5, Thandhai Periyal Nagar, Aariyapadaiveedu, <br/>Kumbakonam - 612703</p>
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={6} className="flex justify-center items-center text-center sm:mb-[20px]">
                            <p className="mb-0">&copy; {new Date().getFullYear()}Proudly Powered by <a aria-label="themezaa" rel="noreferrer" href="https://www.themezaa.com/" className="hover:text-white" target="_blank"> Rook Fellows</a></p>
                        </Col>
